...
public class Examen extends RDV {
    ...
    public Examen(Date dateRDV, TypeExamen typeExamen, int id, int salle, String cr, int idPatient,String medecinPrescri,Date dateExamen, boolean image, boolean validation, String crExamen,String medecinRadio) {
