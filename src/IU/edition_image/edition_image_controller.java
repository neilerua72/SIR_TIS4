...
public class edition_image_controller implements Initializable {
  ...
  /*  private String imageURI = new File("/Users/hugobosquet/Desktop/jpg/brain/brain1_0115.jpg").toURI().toString();
    private Image image = new Image(imageURI);
    private ImageView imageView_editionImage = new ImageView(image);*/
